"""
Django settings for FlowerDeliverySite_0 project.
...
SECRET_KEY = 'django-insecure-bk-xmy#qw2&4$-tdg*fv#pq9=pw+*=t*kz6b_z7)$cc-7(5hnt'
...
INSTALLED_APPS = [
    ...
    'shop',  # здесь должно быть ваше приложение
    'django_extensions',
]
...
ROOT_URLCONF = 'FlowerDeliverySite_0.urls'
...
WSGI_APPLICATION = 'FlowerDeliverySite_0.wsgi.application'
